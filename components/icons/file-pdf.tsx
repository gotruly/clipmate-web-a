...
const PDFFileIcon = ({ width = 24, height = 24, ...rest }: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      width={width}
      height={height}
      ...
      {...rest}
    >
      <g clipPath="url(#clip0_6367_3198)">
        <g filter="url(#filter0_di_6367_3198)">
          <path
        ...
        <g filter="url(#filter1_i_6367_3198)">
          <mask id="path-4-inside-1_6367_3198" fill="white">
          ...
          <path
            ...
            fill="black"
            fillOpacity="0.08"
            mask="url(#path-4-inside-1_6367_3198)"
          />
          <path
      ...
      <defs>
        ...
        >
          ...
          />
          <feBlend mode="normal" in2="BackgroundImageFix" result="effect1_dropShadow_6367_3198" />
          <feBlend
            mode="normal"
            in="SourceGraphic"
            in2="effect1_dropShadow_6367_3198"
            result="shape"
          />
          <feColorMatrix
            in="SourceAlpha"
          ...
          />
          <feBlend mode="normal" in2="shape" result="effect2_innerShadow_6367_3198" />
        </filter>
        <filter
          id="filter1_i_6367_3198"
          x="0"
          y="18"
          width="28"
          height="20"
        ...
        >
          ...
          <feBlend mode="normal" in2="shape" result="effect1_innerShadow_6367_3198" />
        </filter>
        <clipPath id="clip0_6367_3198">
