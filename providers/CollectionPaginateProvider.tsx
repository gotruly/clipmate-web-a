...
const CollectionPaginateProvider = React.memo(
  ({
    url,
    constriant,
    limit,
    ...
    const { store, handleAddItemToPair, handleAddNewPair } = useCollectionStore();
...
CollectionPaginateProvider.displayName = "CollectionPaginateProvider";

export default CollectionPaginateProvider;
