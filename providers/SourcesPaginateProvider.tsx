...
const SourcesPaginateProvider = React.memo(
  ({
    url,
    constriant,
    limit,
    ...
    const { store, handleAddItemToPair, handleAddNewPair } = useSourcesStore();
...
SourcesPaginateProvider.displayName = "SourcesPaginateProvider";

export default SourcesPaginateProvider;
